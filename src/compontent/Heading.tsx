  ...
  return (
    <>
      <div className="relative p-5 my-2 bg-white rounded-md shadow-md">
        <button className="absolute right-5 px-3 py-1.5 font-semibold rounded-md bg-zinc-300 flex items-center gap-2"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
