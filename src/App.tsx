          ...
          <ul className="flex justify-between gap-2 text-sm font-semibold">
            <li>
              <button
                ...
                className={`flex items-center gap-1 border-b-2 pb-1 ${
                  activeTab === 1 ? "text-orange-500 border-orange-500" : " text-zinc-800 border-transparent dark:text-orange-50"
                }`}
              >              
                <span>Overview</span>
              </button>
            ...
            <li>
              <button
                ...
                className={`flex items-center gap-1 border-b-2 pb-1 ${
                  activeTab === 2 ? "text-orange-500 border-orange-500" : " text-zinc-800 border-transparent dark:text-orange-50"
                }`}
              >
                <span>Heading</span>
              </button>
            ...
            <li>
              <button
                ...
                className={`flex items-center gap-1 border-b-2 pb-1 ${
                  activeTab === 7 ? "text-orange-500 border-orange-500" : " text-zinc-800 border-transparent dark:text-orange-50"
                }`}
              >
            ...
            <li>
              <button
                ...
                className={`flex items-center gap-1 border-b-2 pb-1 ${
                  activeTab === 3 ? "text-orange-500 border-orange-500" : " text-zinc-800 border-transparent dark:text-orange-50"
                }`}
              >
                <span>Links</span>
              </button>
            ...
            <li>
              <button
                ...
                className={`flex items-center gap-1 border-b-2 pb-1 ${
                  activeTab === 4 ? "text-orange-500 border-orange-500" : " text-zinc-800 border-transparent dark:text-orange-50"
                }`}
              >
                <span>Images</span>
              </button>
            ...
            <li>
              <button
                ...
                className={`flex items-center gap-1 border-b-2 pb-1 ${
                  activeTab === 5 ? "text-orange-500 border-orange-500" : " text-zinc-800 border-transparent dark:text-orange-50"
                }`}
              >
                <span>Schema</span>
              </button>
            ...
            <li>
              <button
                ...
                className={`flex items-center gap-1 border-b-2 pb-1 ${
                  activeTab === 6 ? "text-orange-500 border-orange-500" : " text-zinc-800 border-transparent dark:text-orange-50"
                }`}
              >
                <span>Social</span>
              </button>
            ...
            <li>
              <button
                ...
                className={`flex items-center gap-1 ${
                  activeTab === 8 ? "text-orange-500 border-orange-500" :  "text-[#F5ECE4]"
                }`}
              >
                <svg
